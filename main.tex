...
\[
\Gamma_1(q_1)\to N(h_1(q_1)),\qquad
\Gamma_2(q_2)\to N(f_2(q_2)).
\]
...
$\Gamma_1(q_1 \le i_1 h_1(q_1))$ is an isomorphism.
...
Because adjoints compose and $\pi_i\dashv\iota_i$ (Lemma~\ref{lem:galois-connection-basics}), we obtain
\[
f_1\pi_1 \dashv \iota_1 g_1, \qquad
h_2\pi_2 \dashv \iota_2 i_2.
\]
